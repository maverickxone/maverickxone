...
- 🔭 **Next plans / ideas (From now to 2026.5.30):**
  - Learning Transformer
  - Preparing for RoboGame
  - Explore Other Things about Current AI.
  - Working On School Work.
  - Exploring ideas (check my knowledge base: https://mav-ustc.dev/knowledge/)
- 📌 **Featured repository (so far):**
  ...
  - **Notion2api** (Build with Claude): [[Notion2api](https://github.com/maverickxone/notion2api)]
